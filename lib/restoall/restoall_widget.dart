...
import 'restoall_model.dart';
export 'restoall_model.dart';

class RestoallWidget extends StatefulWidget {
  const RestoallWidget({Key? key}) : super(key: key);

  @override
  _RestoallWidgetState createState() => _RestoallWidgetState();
}

class _RestoallWidgetState extends State<RestoallWidget> {
  late RestoallModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestoallModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'restoall'});
    // On page load action.
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Column(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children: [
                                                                              if (columnPanierRecord.pay == false)
                                                                                Container(
                                                                                  width: double.infinity,
                                                                                  decoration: BoxDecoration(),
                                                                                  child: Padding(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return Column(
                                                                            mainAxisSize:
                                                                                MainAxisSize.max,
                                                                            children: [
                                                                              if (columnPanierRecord.pay == true)
                                                                                Container(
                                                                                  width: double.infinity,
                                                                                  decoration: BoxDecoration(),
                                                                                  child: Padding(
