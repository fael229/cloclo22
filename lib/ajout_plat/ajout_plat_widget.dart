                                                                                                ...
                                                                                                child: StreamBuilder<List<CatRecord>>(
                                                                                                  ...
                                                                                                  builder: (context, snapshot) {
                                                                                                    ...
                                                                                                    return FlutterFlowDropDown<String>(
                                                                                                      controller: _model.sector123ValueController ??= FormFieldController<String>(null),
                                                                                                      options: sector123CatRecordList.map((e) => e.nom).toList(),
                                                                                              ...
                                                                                              Expanded(
                                                                                                child: StreamBuilder<List<RestaurantsRecord>>(
                                                                                                  ...
                                                                                                  builder: (context, snapshot) {
                                                                                                    ...
                                                                                                    return FlutterFlowDropDown<String>(
                                                                                                      controller: _model.sector222ValueController ??= FormFieldController<String>(null),
                                                                                                      options: sector222RestaurantsRecordList.map((e) => e.nom).toList(),
